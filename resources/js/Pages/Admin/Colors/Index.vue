        ...
        <div
            ...
            <div class="flex items-center flex-1 space-x-4">
                <h5>
                    ...
                    <span class="dark:text-white">{{ colors.length }}</span>
                </h5>
            </div>
            <div
                ...
                <tbody>
                    <tr v-for="color in colors" :key="color.id"
                        ...
                        <td class="px-4 py-3 items-center">
                            <button :id="`${color.id}-dropdown-button`" :data-dropdown-toggle="`${color.id}-dropdown`"
                            ...
                            <div :id="`${color.id}-dropdown`"
                                class="hidden z-10 w-44 bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600">
                                <ul class="py-1 text-sm text-gray-700 dark:text-gray-200"
                                    :aria-labelledby="`${color.id}-dropdown-button`">
                                    <li>
                                ...
                                <div class="py-1">
                                    <a href="#" @click="handleDeleteColor(color, index)"
